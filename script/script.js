...
const displayLevelWOrd = (words) => {
  ...
  words.forEach(word => {
    ...
    <div class="bg-white rounded-xl text-center shadow-sm py-10 px-5 space-y-4">
        ...
        <p class="font-bangla text-2xl font-semibold">${word.meaning ? word.meaning : "অর্থ পাওয়া যাইনি"} / ${word.pronunciation ? word.pronunciation : "Pronunciation পাওয়া যাইনি"}</p>
